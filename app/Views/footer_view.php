...
<div class="container">
  <div class="d-flex justify-content-between">
    <a href="<?php site_url()?>home" class="pt-1">
      <figure class="px-3">
        <img class="img" src="public/assets/img/volver.svg" alt="" class="d-inline-block p-4" width="40">
        <figcaption class="text-center">Volver</figcaption>
      </figure>
    </a>
    <button type="submit" class="btn">
    <figure class="px-3">
      <img class="img" src="public/assets/img/diskette.svg" alt="" class="d-inline-block p-4" width="40">
